...
INSERT INTO `activiti`.`sys_permission` (`PID`, `PNAME`, `TYPE`, `URL`, `PERCODE`, `PARENTID`, `PARENTIDS`, `SORTSRING`, `AVAILABLE`, `MENUICON`) VALUES ('30', '待我阅读', 'menu', '/activiti/read', 'user:read', '2', NULL, '0', '1', '');
