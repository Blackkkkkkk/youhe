...
INSERT INTO `activiti`.`sys_permission`(`PID`, `PNAME`, `TYPE`, `URL`, `PERCODE`, `PARENTID`, `PARENTIDS`, `SORTSRING`, `AVAILABLE`, `MENUICON`) VALUES (17, '订单列表', 'menu', '/order/list', 'shop:orderManage', 16, '0/14/', '1', '1', NULL);
