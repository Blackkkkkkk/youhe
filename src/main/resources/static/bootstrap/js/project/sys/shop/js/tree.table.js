...
(function () {
    ...
    var TreeTable = function (tableId, url, columns) {
        ...
        this.pageNumber = 1;                   //初始化加载第一页，默认第一页,并记录
        this.pageSize = 10;                    //每页的记录行数（*）
        this.pageList = [10, 25, 50, 100];        //可供选择的每页的行数（*）
    };
                ...
                $('#' + tableId).bootstrapTreeTable({
                    ...
                    queryParams: function (params) {
                        ...
                        var temp = {
                            ...
                            page: (params.total / params.pageSize) + 1,   //页码
    ...
    console.log(TreeTable.prototype)
