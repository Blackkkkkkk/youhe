...
public class DruidConfiguation {
    ...
    private Logger logger = LoggerFactory.getLogger(DruidConfiguation.class);
    ...
    public SqlSessionFactoryBean sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource) {
        ...
        try {
            ...
            bean.setTypeAliasesPackage("com.youhe.entity");
            bean.setConfigLocation(resourcePatternResolver.getResource(configLocation));
